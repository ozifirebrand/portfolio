...
- <div class="snippet-clipboard-content" data-snippet-clipboard-copy-content="npm install gh-pages --save-dev"><pre class="notranslate"><code>npm install gh-pages --save-dev
</code></pre></div>
